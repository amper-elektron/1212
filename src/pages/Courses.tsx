  ...
  return (
    <>
      ...
      >
        ...
        {/* ── HERO ── same dark card style as Blog's featured post ── */}
        <section className="courses-hero">
          <div className="max-w-6xl mx-auto px-5 sm:px-8 py-20 lg:py-28 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div>
              ...
              >
                Find Your<br />
                <span style={{ color: '#C9A96E', fontStyle: 'italic' }}>Perfect</span> Course
              </motion.h1>
              ...
              >
                Whether you're preparing for exams or just want to speak confidently —
                there's a program built exactly for you.
              </motion.p>
              ...
              >
                {['All Levels', 'Exam Prep', 'Conversation', 'Business'].map(tag => (
                  <span
                    key={tag}
                    className="tag-pill"
                    style={{ background: 'rgba(201,169,110,0.12)', color: '#C9A96E', borderColor: 'rgba(201,169,110,0.3)' }}
                  >
                    {tag}
                  </span>
                ))}
            ...
            {/* Stats grid — same card feel as Blog modal */}
            <motion.div
            ...
            >
              {[
                ...
                { val: 98,  suffix: '%', label: 'Satisfaction Rate',  Icon: Star },
                { val: 6,   suffix: '',  label: 'Active Programs',    Icon: BookOpen },
                { val: 4,   suffix: '+', label: 'Years Teaching',     Icon: Calendar },
                ...
                >
                  ...
                  <span className="section-label" style={{ color: 'rgba(255,255,255,0.35)' }}>{label}</span>
                </div>
              ))}
            </motion.div>
          </div>
